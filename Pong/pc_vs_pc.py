...
while True:
    ...
    borda_esquerda = pygame.draw.rect(tela, (0, 0, 0), (0, 0, 1, largura))
    borda_direita = pygame.draw.rect(tela, (0, 0, 0), ((largura - 1), 0, 1, largura))
    borda_cima = pygame.draw.rect(tela, (0, 0, 0), (0, 0, largura, 1))
    borda_baixo = pygame.draw.rect(tela, (0, 0, 0), (0, (altura - 1), largura, 1))
    ...
    if y_direita != y_bola:
        ...
        if y_direita > y_bola:
            y_direita = y_direita - velocidade_pongs
    if y_esquerda != y_bola:
        if y_bola > y_esquerda:
            y_esquerda = y_esquerda + velocidade_pongs
        if y_esquerda > y_bola:
            y_esquerda = y_esquerda - velocidade_pongs
